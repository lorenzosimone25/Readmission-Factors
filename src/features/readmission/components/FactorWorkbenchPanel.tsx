    ...
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto p-3">
        {groups.length === 0 ? (
          ...
          >
            Add a readmission factor below, then select text in the note and click Highlight.
          </p>
        ) : null}
      ...
      >
        <button
          type="button"
          onClick={() => onAddFactor()}
          className="flex w-full items-center justify-center gap-1.5 rounded-lg border py-2 text-xs font-semibold"
          style={{
            borderColor: 'var(--color-border-strong)',
